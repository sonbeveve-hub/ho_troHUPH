...
export default function OrganicBackdrop() {
  return (
    <div className="fixed inset-0 overflow-hidden pointer-events-none z-0">
      <div
        className="absolute -top-24 -left-24 h-[420px] w-[420px] bg-brand-200/70 blur-3xl"
        style={{ borderRadius: '42% 58% 70% 30% / 45% 45% 55% 55%' }}
      />
      <div
        className="absolute top-1/3 -right-32 h-[480px] w-[480px] bg-brand-100/80 blur-3xl"
        style={{ borderRadius: '60% 40% 30% 70% / 50% 60% 40% 50%' }}
      />
      <div
        className="absolute -bottom-32 left-1/4 h-[380px] w-[380px] bg-emerald-100/70 blur-3xl"
        style={{ borderRadius: '38% 62% 63% 37% / 41% 44% 56% 59%' }}
      />
      <div
        className="absolute bottom-0 right-0 h-[300px] w-[300px] bg-white/60 blur-3xl"
